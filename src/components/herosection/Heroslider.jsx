...
function Heroslider() {
  ...
  return (
    <div class="relative">
          <Headersection className="relative  " />

    <Carousel  activeIndex={index}
        onSelect={handleSelect}
        controls={false}
        interval={1000}
        className="absolute inset-0 custom-z-index">
      ...
      <Carousel.Item style={{ backgroundImage: `url(${img1})`,backgroundSize: 'cover',backgroundPosition: 'center center' }} className='md:h-[700px] xs:h-[500px] w-full'>
        ...
        <p className='md:text-md font-serif xs:text-sm z--1 ' >Studeon innovative & successfull</p>
    ...
    <div class="absolute bottom-0 left-0 right-0 flex flex-col items-center mb-[-30px] hederbottom custom-z-index">
