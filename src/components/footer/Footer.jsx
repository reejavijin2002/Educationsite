      ...
      <div className="w-full md:h-[350px] xs:h-auto bg-[#323131] p-10 md:flex">
        <div className="md:w-1/3 xs:w-full pl-2">
          ...
          <p className="text-sm text-stone-400">
            Omnis iste natus sit voluptatem accusanti dolorem laudantium totam
            rem aperiam.
          </p>
          <p className="text-sm text-stone-400">
        ...
        <div className="md:w-1/3 xs:w-full pl-2">
          ...
          <div className="flex  ">
            ...
            <div>
              <p className="text-xs text-white font-medium pl-2">
                Facing Your Fears of Returning To School as an Adult
              </p>
              <p className="text-xs text-gray-400 font-medium pl-2 mt-[-10px]">
        ...
        <div className="md:w-1/3 xs:w-full">
          ...
          <div className="flex">
            <input
              ...
              className="p-2 bg-black md:w-52 xs:w-36"
            />
            <button className="bg-green-500 text-white font-medium p-2 ">
              Subscribe
            </button>
          </div>
        </div>
